...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  const contextValue = useMemo(
    () => ({
      ...
      getBounds: () => mapInstance?.getBounds() ?? null,
    }),
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="overflow-hidden rounded-2xl border border-white/10 bg-black/65 shadow-xl backdrop-blur-2xl">
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex size-12 items-center justify-center transition-all hover:bg-white/20 active:scale-95 md:size-10",
